...
<body>
    ...
    <div class="container-fluid page-header py-5" style="margin-bottom: 6rem">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Kiriman Tuntas</h1>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex flex-column">
                                            ...
                                            <span>WA/HP: <br><a href="whatsapp://send?text=Salam, <?= $x->nama_penerima ?>.&phone=+<?= $x->wa_penerima ?>&abid=+<?= $x->wa_penerima ?>" class="btn btn-success btn-sm"><i class="bi bi-whatsapp"></i></a> <a href="tel:+<?= $x->hp_penerima ?>" class="btn btn-primary btn-sm"><i class="bi bi-telephone-forward-fill"></i></a></span>
                                        </div>
                                    </td>
                                    <td><?= $x->negara ?></td>
                                    <td>
                                        <div class="d-flex flex-column">
                                            <span class="text-success">Sudah diterima pemilik di alamat tujuan <br>Tanggal: <?= $x->updated_at ?></span>
