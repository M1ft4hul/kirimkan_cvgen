                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if (session()->get('kode_admin') == "JR" && $x->negara == "Indonesia") { ?>
                                            <span class="text-danger">Menunggu paket, untuk dihitung berat dan biaya kirim ke Indonesia</span>
                                        <?php } elseif (session()->get('kode_admin') == "ID" && $x->negara == "Jerman") { ?>
                                            <span class="text-danger">Menunggu paket, untuk dihitung berat dan biaya kirim ke Jerman</span>
                                        <?php } ?>
                                    </td>
                                    <td>
