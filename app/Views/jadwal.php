...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow border-top border-5 border-primary sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="<?php echo base_url('/PageJadwal') ?>" class="nav-item nav-link active">Jadwal</a>
    ...
    <div class="container-fluid page-header py-5" style="margin-bottom: 6rem">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Informasi Jadwal Pengiriman Barang</h1>
    ...
    <div class="container-xxl ">
        <div class="container ">
            ...
            <div class="container rounded mt-5 bg-white p-md-5">
                <div class="h2 font-weight-bold">Jadwal Jastip Jerman - Indonesia</div>
                <div class="table-responsive">
                    <a href="whatsapp://send?text=Salam Admin, Saya ingin mengirim Jerman - Indonesia, .&phone=+6285298649951&abid=+6285298649951'" target="_blank" class="btn btn-primary">Hubungi Admin</a>

                    <!-- tabel Jerman - Indonesia -->
                    <?php if ($jastipJI) { ?>
                        <table id="meetingsTable" class="table">
                            ...
                            <tbody>
                                <?php
                                foreach ($jastipJI as $x) { ?>
                                    <tr class="bg-blue">
                                        <td class="pt-2"> <img width="50" height="50" src="<?php echo base_url() ?>/img/box.png" alt="">
                                            <div class="pl-lg-5 pl-md-3 pl-1 name">Pengiriman Hari <?php echo $x->hari ?></div>
                                        </td>
                                        <td class="pt-3 mt-1"><?php echo date('d M Y', strtotime($x->tanggal)) ?></td>
                                    </tr>
                                    <tr id="spacing-row">
                                        <td></td>
                                    </tr>
                    ...
                    <?php } else { ?>
                        ...
                        <p class="ms-3">Belum ada Jadwal Pengantaran</p>
                    <?php } ?>
                </div>
            </div>
            ...
            <div class="container rounded mt-2 bg-white p-md-5">
                <div class="h2 font-weight-bold">Jadwal Jastip Indonesia - Jerman</div>
                <div class="table-responsive">
                    <a href="whatsapp://send?text=Salam Admin, Saya ingin mengirim Indonesia - Jerman, .&phone=+6285298649951&abid=+6285298649951'" target="_blank" class="btn btn-primary">Hubungi Admin</a>
                    <!-- tabel Indonesia - Jerman -->
                    <?php if ($jastipIJ) { ?>
                        <table id="number" class="table">
                            <thead>
                                <tr>
                                    <th scope="col">Hari</th>
                                    <th scope="col">Tanggal</th>
                        ...
                        <!-- Pagination -->
                        <div id="viewPagination" class="pagination mt-3"></div>
                    <?php } else { ?>
                        <!-- echo 'Belum ada data kandidat'; -->
                        <p class="ms-3">Belum ada Jadwal Pengantaran</p>
                    <?php } ?>
