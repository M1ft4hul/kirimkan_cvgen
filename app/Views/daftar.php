...
<body>
    ...
    <div class="container-fluid page-header py-5" style="margin-bottom: 6rem">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Pengirim</h1>
    ...
    <div class="container-xxl ">
        <div class="container ">
            <div class="row g-5 wow fadeIn" data-wow-delay="0.1s">
                ...
                <form action="<?= base_url() ?>/simpan-daftar" method="POST">
                    <?= csrf_field() ?>
                    <div class="row g-3">
                        <div class="form-floating">
                            <input type="nama" class="form-control <?= ($validation->hasError('nama')) ? 'is-invalid'  : ''; ?>" id="nama" name="nama" value="<?= old('nama') ?>" placeholder="Nama Lengkap" />
                        ...
                        <div class="form-check mt-0 ms-2">
                            <input class="form-check-input <?= ($validation->hasError('setuju')) ? 'is-invalid'  : ''; ?>" type="checkbox" role="switch" name="setuju" value="1" id="flexSwitchCheckChecked" <?= old('setuju') == '1' ? 'checked' : '' ?>>
                            <label class="form-check-label" for="flexSwitchCheckChecked">Setuju <a href="<?= base_url('/terms'); ?>" class="text-success" onclick="loading()">Syarat & Ketentuan</a></label>
                ...
                <div class="mt-3">
                    <h6>Sudah punya akun? <a href="<?= base_url() ?>/login">Login</a></h6>
                </div>
            </div>
        </div>
    </div>
